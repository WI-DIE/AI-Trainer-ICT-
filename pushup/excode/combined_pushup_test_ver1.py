...
import numpy as np
from pushup.utils_pushup import calculate_angle, draw_angle, resize_with_padding
...
INPUT_VIDEO_PATH = "pushuptimer.mp4"
    ...
    while video.isOpened() and cap.isOpened():
        ...
        try:
            ...
            if left_angle < 70 and right_angle < 70 and left_core >= 160 and right_core >= 160:
                stage = "up"
            if left_angle >= 170 and right_angle >= 170 and stage == 'up' and left_core >= 160 and right_core >= 160:
                stage = "down"
                counter += 1
            ...
            bar_x_start, bar_x_end = 10, 210
            bar_y_start, bar_y_end = 200, 220
            ...
            cv2.putText(combined_frame, f'{int(percent)}%', (bar_x_end + 10,
                        bar_y_start + 15), cv2.FONT_HERSHEY_COMPLEX, 0.7, (255, 255, 255), 2)
